...
public class GetCarWorkshopByEncodedNameQueryHandler
    : IRequestHandler<GetCarWorkshopByEncodedNameQuery, CarWorkshopDto>
{
    ...
    public async Task<CarWorkshopDto> Handle(
        GetCarWorkshopByEncodedNameQuery request,
